...
<img src="C:\Users\Edenman\AppData\Roaming\Typora\typora-user-images\image-20210617191823649.png" alt="image-20210617191823649" style="zoom:67%;" />
...
1、数据库中添加exam表，包含字段：id, title(varchar), create_time, deadline_time，用于存放考试的基本信息，包含id，测试标题，创建时间，截止时间
...
4、前端传给后端 { **courseID, examTitle（考试标题）, questions数组（内含多个question对象）**}
